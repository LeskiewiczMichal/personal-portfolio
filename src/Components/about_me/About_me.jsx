      ...
      <div className="about-me--wrapper">
        ...
        <div className="about-me--text-wrapper">
          ...
          <p className="about-me--paragraph">
            ...
            officia saepe vero ducimus sit, facilis blanditiis distinctio
            eligendi obcaecati ipsum, voluptas, recusandae porro commodi nisi
            ipsa minus quibusdam corporis? Tempore!
          </p>
          <div className="about-me--links">
            <a href="https://github.com/LeskiewiczMichal">
              <img className="about-me--icon" src={githubIcon} alt="github" />
            </a>
